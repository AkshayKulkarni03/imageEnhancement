...
/**
 * Detect face in the image and mask only the rectangular area of face. This is
 * singleton class for better reference and usage.
 * 
 * @author akshay
 */
public class DetectFaceFromImage {

	private static AtomicReference<DetectFaceFromImage> instaceOfDetectFaceFromImage = new AtomicReference<>(
			new DetectFaceFromImage());
	...
	/**
	 * Rotate the image 360 degree and try to match the face in correct position and
	 * return the image in that rotation
	 * 
